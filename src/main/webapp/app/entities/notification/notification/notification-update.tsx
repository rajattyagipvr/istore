  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="istoreApp.notificationNotification.home.createOrEditLabel">
            <Translate contentKey="istoreApp.notificationNotification.home.createOrEditLabel">Create or edit a Notification</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : notificationEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="dateLabel" for="notification-date">
                  <Translate contentKey="istoreApp.notificationNotification.date">Date</Translate>
                </Label>
                <AvInput
              ...
              <AvGroup>
                <Label id="detailsLabel" for="notification-details">
                  <Translate contentKey="istoreApp.notificationNotification.details">Details</Translate>
                </Label>
                <AvField id="notification-details" type="text" name="details" />
              </AvGroup>
              <AvGroup>
                <Label id="sentDateLabel" for="notification-sentDate">
                  <Translate contentKey="istoreApp.notificationNotification.sentDate">Sent Date</Translate>
                </Label>
                <AvInput
              ...
              <AvGroup>
                <Label id="formatLabel" for="notification-format">
                  <Translate contentKey="istoreApp.notificationNotification.format">Format</Translate>
                </Label>
                <AvInput
                ...
                >
                  <option value="EMAIL">{translate('istoreApp.NotificationType.EMAIL')}</option>
                  <option value="SMS">{translate('istoreApp.NotificationType.SMS')}</option>
                  <option value="PARCEL">{translate('istoreApp.NotificationType.PARCEL')}</option>
                </AvInput>
              </AvGroup>
              <AvGroup>
                <Label id="userIdLabel" for="notification-userId">
                  <Translate contentKey="istoreApp.notificationNotification.userId">User Id</Translate>
                </Label>
                <AvField
              ...
              <AvGroup>
                <Label id="productIdLabel" for="notification-productId">
                  <Translate contentKey="istoreApp.notificationNotification.productId">Product Id</Translate>
                </Label>
                <AvField
