  ...
  return (
    <div>
      <h2 id="notification-heading">
        <Translate contentKey="istoreApp.notificationNotification.home.title">Notifications</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="istoreApp.notificationNotification.home.createLabel">Create new Notification</Translate>
        </Link>
      </h2>
        ...
        {notificationList && notificationList.length > 0 ? (
            ...
            <tbody>
              {notificationList.map((notification, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    <Translate contentKey={`istoreApp.NotificationType.${notification.format}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="istoreApp.notificationNotification.home.notFound">No Notifications found</Translate>
            </div>
          )
        )}
      </div>
