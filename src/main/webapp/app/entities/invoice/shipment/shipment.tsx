  ...
  return (
    <div>
      <h2 id="shipment-heading">
        <Translate contentKey="istoreApp.invoiceShipment.home.title">Shipments</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="istoreApp.invoiceShipment.home.createLabel">Create new Shipment</Translate>
        </Link>
      </h2>
        ...
        {shipmentList && shipmentList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('trackingCode')}>
                  <Translate contentKey="istoreApp.invoiceShipment.trackingCode">Tracking Code</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('date')}>
                  <Translate contentKey="istoreApp.invoiceShipment.date">Date</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('details')}>
                  <Translate contentKey="istoreApp.invoiceShipment.details">Details</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="istoreApp.invoiceShipment.invoice">Invoice</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="istoreApp.invoiceShipment.home.notFound">No Shipments found</Translate>
            </div>
          )
        )}
      </div>
