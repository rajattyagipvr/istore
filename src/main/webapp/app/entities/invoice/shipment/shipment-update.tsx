  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="istoreApp.invoiceShipment.home.createOrEditLabel">
            <Translate contentKey="istoreApp.invoiceShipment.home.createOrEditLabel">Create or edit a Shipment</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : shipmentEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="trackingCodeLabel" for="shipment-trackingCode">
                  <Translate contentKey="istoreApp.invoiceShipment.trackingCode">Tracking Code</Translate>
                </Label>
                <AvField id="shipment-trackingCode" type="text" name="trackingCode" />
              </AvGroup>
              <AvGroup>
                <Label id="dateLabel" for="shipment-date">
                  <Translate contentKey="istoreApp.invoiceShipment.date">Date</Translate>
                </Label>
                <AvInput
                  id="shipment-date"
                  type="datetime-local"
              ...
              <AvGroup>
                <Label id="detailsLabel" for="shipment-details">
                  <Translate contentKey="istoreApp.invoiceShipment.details">Details</Translate>
                </Label>
                <AvField id="shipment-details" type="text" name="details" />
              </AvGroup>
              <AvGroup>
                <Label for="shipment-invoice">
                  <Translate contentKey="istoreApp.invoiceShipment.invoice">Invoice</Translate>
                </Label>
                <AvInput
                  id="shipment-invoice"
                  type="select"
