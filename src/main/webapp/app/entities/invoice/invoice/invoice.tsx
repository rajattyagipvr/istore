  ...
  return (
    <div>
      <h2 id="invoice-heading">
        <Translate contentKey="istoreApp.invoiceInvoice.home.title">Invoices</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="istoreApp.invoiceInvoice.home.createLabel">Create new Invoice</Translate>
        </Link>
      </h2>
        ...
        {invoiceList && invoiceList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('code')}>
                  <Translate contentKey="istoreApp.invoiceInvoice.code">Code</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('date')}>
                  <Translate contentKey="istoreApp.invoiceInvoice.date">Date</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('details')}>
                  <Translate contentKey="istoreApp.invoiceInvoice.details">Details</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('status')}>
                  <Translate contentKey="istoreApp.invoiceInvoice.status">Status</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('paymentMethod')}>
                  <Translate contentKey="istoreApp.invoiceInvoice.paymentMethod">Payment Method</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('paymentDate')}>
                  <Translate contentKey="istoreApp.invoiceInvoice.paymentDate">Payment Date</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('paymentAmount')}>
                  <Translate contentKey="istoreApp.invoiceInvoice.paymentAmount">Payment Amount</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {invoiceList.map((invoice, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    <Translate contentKey={`istoreApp.InvoiceStatus.${invoice.status}`} />
                  </td>
                  <td>
                    <Translate contentKey={`istoreApp.PaymentMethod.${invoice.paymentMethod}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="istoreApp.invoiceInvoice.home.notFound">No Invoices found</Translate>
            </div>
          )
        )}
      </div>
