  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="istoreApp.invoiceInvoice.home.createOrEditLabel">
            <Translate contentKey="istoreApp.invoiceInvoice.home.createOrEditLabel">Create or edit a Invoice</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : invoiceEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="codeLabel" for="invoice-code">
                  <Translate contentKey="istoreApp.invoiceInvoice.code">Code</Translate>
                </Label>
                <AvField
                  id="invoice-code"
                  type="text"
              ...
              <AvGroup>
                <Label id="dateLabel" for="invoice-date">
                  <Translate contentKey="istoreApp.invoiceInvoice.date">Date</Translate>
                </Label>
                <AvInput
                  id="invoice-date"
                  type="datetime-local"
              ...
              <AvGroup>
                <Label id="detailsLabel" for="invoice-details">
                  <Translate contentKey="istoreApp.invoiceInvoice.details">Details</Translate>
                </Label>
                <AvField id="invoice-details" type="text" name="details" />
              </AvGroup>
              <AvGroup>
                <Label id="statusLabel" for="invoice-status">
                  <Translate contentKey="istoreApp.invoiceInvoice.status">Status</Translate>
                </Label>
                <AvInput
                  id="invoice-status"
                  type="select"
                ...
                >
                  <option value="PAID">{translate('istoreApp.InvoiceStatus.PAID')}</option>
                  <option value="ISSUED">{translate('istoreApp.InvoiceStatus.ISSUED')}</option>
                  <option value="CANCELLED">{translate('istoreApp.InvoiceStatus.CANCELLED')}</option>
                </AvInput>
              </AvGroup>
              <AvGroup>
                <Label id="paymentMethodLabel" for="invoice-paymentMethod">
                  <Translate contentKey="istoreApp.invoiceInvoice.paymentMethod">Payment Method</Translate>
                </Label>
                <AvInput
                ...
                >
                  <option value="CREDIT_CARD">{translate('istoreApp.PaymentMethod.CREDIT_CARD')}</option>
                  <option value="CASH_ON_DELIVERY">{translate('istoreApp.PaymentMethod.CASH_ON_DELIVERY')}</option>
                  <option value="PAYPAL">{translate('istoreApp.PaymentMethod.PAYPAL')}</option>
                </AvInput>
              </AvGroup>
              <AvGroup>
                <Label id="paymentDateLabel" for="invoice-paymentDate">
                  <Translate contentKey="istoreApp.invoiceInvoice.paymentDate">Payment Date</Translate>
                </Label>
                <AvInput
              ...
              <AvGroup>
                <Label id="paymentAmountLabel" for="invoice-paymentAmount">
                  <Translate contentKey="istoreApp.invoiceInvoice.paymentAmount">Payment Amount</Translate>
                </Label>
                <AvField
