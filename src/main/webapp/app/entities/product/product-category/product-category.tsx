  ...
  return (
    <div>
      <h2 id="product-category-heading">
        <Translate contentKey="istoreApp.productProductCategory.home.title">Product Categories</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="istoreApp.productProductCategory.home.createLabel">Create new Product Category</Translate>
        </Link>
      </h2>
        ...
        {productCategoryList && productCategoryList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="istoreApp.productProductCategory.name">Name</Translate>
                </th>
                <th>
                  <Translate contentKey="istoreApp.productProductCategory.description">Description</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="istoreApp.productProductCategory.home.notFound">No Product Categories found</Translate>
            </div>
          )
        )}
      </div>
