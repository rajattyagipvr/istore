...
export const ProductCategoryDeleteDialog = (props: IProductCategoryDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="istoreApp.productProductCategory.delete.question">
        <Translate contentKey="istoreApp.productProductCategory.delete.question" interpolate={{ id: productCategoryEntity.id }}>
