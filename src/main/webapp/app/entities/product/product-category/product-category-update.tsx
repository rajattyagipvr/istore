  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="istoreApp.productProductCategory.home.createOrEditLabel">
            <Translate contentKey="istoreApp.productProductCategory.home.createOrEditLabel">Create or edit a ProductCategory</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
