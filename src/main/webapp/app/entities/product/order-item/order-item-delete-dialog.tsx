...
export const OrderItemDeleteDialog = (props: IOrderItemDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="istoreApp.productOrderItem.delete.question">
        <Translate contentKey="istoreApp.productOrderItem.delete.question" interpolate={{ id: orderItemEntity.id }}>
