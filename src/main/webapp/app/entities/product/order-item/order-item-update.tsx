  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="istoreApp.productOrderItem.home.createOrEditLabel">
            <Translate contentKey="istoreApp.productOrderItem.home.createOrEditLabel">Create or edit a OrderItem</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : orderItemEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="quantityLabel" for="order-item-quantity">
                  <Translate contentKey="istoreApp.productOrderItem.quantity">Quantity</Translate>
                </Label>
                <AvField
              ...
              <AvGroup>
                <Label id="totalPriceLabel" for="order-item-totalPrice">
                  <Translate contentKey="istoreApp.productOrderItem.totalPrice">Total Price</Translate>
                </Label>
                <AvField
              ...
              <AvGroup>
                <Label id="statusLabel" for="order-item-status">
                  <Translate contentKey="istoreApp.productOrderItem.status">Status</Translate>
                </Label>
                <AvInput
                ...
                >
                  <option value="AVAILABLE">{translate('istoreApp.OrderItemStatus.AVAILABLE')}</option>
                  <option value="OUT_OF_STOCK">{translate('istoreApp.OrderItemStatus.OUT_OF_STOCK')}</option>
                  <option value="BACK_ORDER">{translate('istoreApp.OrderItemStatus.BACK_ORDER')}</option>
                </AvInput>
              </AvGroup>
              <AvGroup>
                <Label for="order-item-product">
                  <Translate contentKey="istoreApp.productOrderItem.product">Product</Translate>
                </Label>
                <AvInput
              ...
              <AvGroup>
                <Label for="order-item-order">
                  <Translate contentKey="istoreApp.productOrderItem.order">Order</Translate>
                </Label>
                <AvInput
                  id="order-item-order"
                  type="select"
