  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="istoreApp.productProduct.home.createOrEditLabel">
            <Translate contentKey="istoreApp.productProduct.home.createOrEditLabel">Create or edit a Product</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : productEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="nameLabel" for="product-name">
                  <Translate contentKey="istoreApp.productProduct.name">Name</Translate>
                </Label>
                <AvField
                  id="product-name"
                  type="text"
              ...
              <AvGroup>
                <Label id="descriptionLabel" for="product-description">
                  <Translate contentKey="istoreApp.productProduct.description">Description</Translate>
                </Label>
                <AvField id="product-description" type="text" name="description" />
              </AvGroup>
              <AvGroup>
                <Label id="priceLabel" for="product-price">
                  <Translate contentKey="istoreApp.productProduct.price">Price</Translate>
                </Label>
                <AvField
                  id="product-price"
                  type="text"
              ...
              <AvGroup>
                <Label id="sizeLabel" for="product-size">
                  <Translate contentKey="istoreApp.productProduct.size">Size</Translate>
                </Label>
                <AvInput id="product-size" type="select" className="form-control" name="size" value={(!isNew && productEntity.size) || 'S'}>
                  <option value="S">{translate('istoreApp.Size.S')}</option>
                  <option value="M">{translate('istoreApp.Size.M')}</option>
                  <option value="L">{translate('istoreApp.Size.L')}</option>
                  <option value="XL">{translate('istoreApp.Size.XL')}</option>
                  <option value="XXL">{translate('istoreApp.Size.XXL')}</option>
                </AvInput>
              </AvGroup>
              <AvGroup>
                <AvGroup>
                  <Label id="imageLabel" for="image">
                    <Translate contentKey="istoreApp.productProduct.image">Image</Translate>
                  </Label>
                  <br />
                  {image ? (
                    <div>
