  ...
  return (
    <div>
      <h2 id="product-heading">
        <Translate contentKey="istoreApp.productProduct.home.title">Products</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="istoreApp.productProduct.home.createLabel">Create new Product</Translate>
        </Link>
      </h2>
        ...
        {productList && productList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('name')}>
                  <Translate contentKey="istoreApp.productProduct.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('description')}>
                  <Translate contentKey="istoreApp.productProduct.description">Description</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('price')}>
                  <Translate contentKey="istoreApp.productProduct.price">Price</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('size')}>
                  <Translate contentKey="istoreApp.productProduct.size">Size</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('image')}>
                  <Translate contentKey="istoreApp.productProduct.image">Image</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="istoreApp.productProduct.productCategory">Product Category</Translate>{' '}
            ...
            <tbody>
              {productList.map((product, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{product.price}</td>
                  <td>
                    <Translate contentKey={`istoreApp.Size.${product.size}`} />
                  </td>
                  <td>
                    {product.image ? (
                      <div>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="istoreApp.productProduct.home.notFound">No Products found</Translate>
            </div>
          )
        )}
      </div>
