...
export const ProductOrderDeleteDialog = (props: IProductOrderDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="istoreApp.productProductOrder.delete.question">
        <Translate contentKey="istoreApp.productProductOrder.delete.question" interpolate={{ id: productOrderEntity.id }}>
