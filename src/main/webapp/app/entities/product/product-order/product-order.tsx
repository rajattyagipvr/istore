  ...
  return (
    <div>
      <h2 id="product-order-heading">
        <Translate contentKey="istoreApp.productProductOrder.home.title">Product Orders</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="istoreApp.productProductOrder.home.createLabel">Create new Product Order</Translate>
        </Link>
      </h2>
        ...
        {productOrderList && productOrderList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('placedDate')}>
                  <Translate contentKey="istoreApp.productProductOrder.placedDate">Placed Date</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('status')}>
                  <Translate contentKey="istoreApp.productProductOrder.status">Status</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('code')}>
                  <Translate contentKey="istoreApp.productProductOrder.code">Code</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('invoiceId')}>
                  <Translate contentKey="istoreApp.productProductOrder.invoiceId">Invoice Id</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('customer')}>
                  <Translate contentKey="istoreApp.productProductOrder.customer">Customer</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {productOrderList.map((productOrder, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    <Translate contentKey={`istoreApp.OrderStatus.${productOrder.status}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="istoreApp.productProductOrder.home.notFound">No Product Orders found</Translate>
            </div>
          )
        )}
      </div>
