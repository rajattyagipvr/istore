  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="istoreApp.productProductOrder.home.createOrEditLabel">
            <Translate contentKey="istoreApp.productProductOrder.home.createOrEditLabel">Create or edit a ProductOrder</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : productOrderEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="placedDateLabel" for="product-order-placedDate">
                  <Translate contentKey="istoreApp.productProductOrder.placedDate">Placed Date</Translate>
                </Label>
                <AvInput
              ...
              <AvGroup>
                <Label id="statusLabel" for="product-order-status">
                  <Translate contentKey="istoreApp.productProductOrder.status">Status</Translate>
                </Label>
                <AvInput
                ...
                >
                  <option value="COMPLETED">{translate('istoreApp.OrderStatus.COMPLETED')}</option>
                  <option value="PENDING">{translate('istoreApp.OrderStatus.PENDING')}</option>
                  <option value="CANCELLED">{translate('istoreApp.OrderStatus.CANCELLED')}</option>
                </AvInput>
              </AvGroup>
              <AvGroup>
                <Label id="codeLabel" for="product-order-code">
                  <Translate contentKey="istoreApp.productProductOrder.code">Code</Translate>
                </Label>
                <AvField
              ...
              <AvGroup>
                <Label id="invoiceIdLabel" for="product-order-invoiceId">
                  <Translate contentKey="istoreApp.productProductOrder.invoiceId">Invoice Id</Translate>
                </Label>
              ...
              <AvGroup>
                <Label id="customerLabel" for="product-order-customer">
                  <Translate contentKey="istoreApp.productProductOrder.customer">Customer</Translate>
                </Label>
                <AvField
