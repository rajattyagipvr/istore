...
export class InvoiceDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('istoreApp.invoiceInvoice.delete.question'));
...
export default class InvoiceComponentsPage {
  ...
  async deleteInvoice() {
    ...
    expect(await invoiceDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/istoreApp.invoiceInvoice.delete.question/);
