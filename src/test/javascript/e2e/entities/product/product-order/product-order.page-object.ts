...
export class ProductOrderDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('istoreApp.productProductOrder.delete.question'));
...
export default class ProductOrderComponentsPage {
  ...
  async deleteProductOrder() {
    ...
    expect(await productOrderDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/istoreApp.productProductOrder.delete.question/);
