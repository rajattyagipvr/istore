...
export class OrderItemDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('istoreApp.productOrderItem.delete.question'));
...
export default class OrderItemComponentsPage {
  ...
  async deleteOrderItem() {
    ...
    expect(await orderItemDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/istoreApp.productOrderItem.delete.question/);
