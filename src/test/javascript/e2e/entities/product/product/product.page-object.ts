...
export class ProductDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('istoreApp.productProduct.delete.question'));
...
export default class ProductComponentsPage {
  ...
  async deleteProduct() {
    ...
    expect(await productDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/istoreApp.productProduct.delete.question/);
