...
export class CustomerDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('istoreApp.customer.delete.question'));
...
export default class CustomerComponentsPage {
  ...
  async deleteCustomer() {
    ...
    expect(await customerDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/istoreApp.customer.delete.question/);
